...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-background text-foreground border-t border-white/[0.04]">
      {/* Hero */}
      <div className="pt-24 pb-12 px-6 text-center relative">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-accent/30 bg-accent/10 text-accent text-xs font-semibold mb-5">
          ...
          >
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-4 p-5 rounded-2xl border border-white/10 bg-white/3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-1">For non-urgent questions</p>
                    <a
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl border border-white/10 bg-white/3">
                  ...
                  <div>
                    <p className="text-foreground font-semibold mb-1">Enterprise sales</p>
                    <p className="text-muted-foreground text-sm mb-1">Talk directly with our team</p>
                    <a
            ...
            <div className="p-5 rounded-2xl border border-white/10 bg-white/3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-muted-foreground text-sm font-medium">Response times</p>
              </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
                        ...
                        <span className="text-foreground/80">{form.email}</span> as soon as possible.
                      </p>
                    </div>
                    <button
                      onClick={() => {
                  ...
                  >
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-foreground text-sm placeholder-white/25 focus:outline-none focus:border-accent/50 transition-colors"
                        />
                      </div>
                      <div>
                        <label className="text-muted-foreground text-xs font-medium mb-1.5 block">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:border-accent/50 transition-colors appearance-none cursor-pointer"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-foreground text-sm placeholder-white/25 focus:outline-none focus:border-accent/50 transition-colors resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex items-center justify-center gap-2 bg-accent hover:bg-[#0284C7] disabled:opacity-60 text-foreground font-semibold py-3.5 rounded-xl transition-all"
                    >
                      {loading ? (
                        <>
