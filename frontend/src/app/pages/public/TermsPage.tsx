  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <div className="mb-12">
            <p className="text-muted-foreground text-sm mb-2">Effective date: June 1, 2025</p>
          ...
          <div className="mb-10 p-5 rounded-2xl border border-white/10 bg-white/3">
            <p className="text-muted-foreground text-xs font-semibold uppercase tracking-widest mb-3">Contents</p>
          ...
          <div className="flex flex-col gap-10">
            {sections.map(({ title, content }, i) => (
              ...
              >
                ...
                <div className="text-muted-foreground text-sm leading-loose whitespace-pre-line">
                  {content}
                </div>
              </motion.section>
            ))}
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <p className="text-muted-foreground text-sm">
              ...
              <a href="mailto:legal@cloudtaskpro.com" className="text-accent hover:underline">
