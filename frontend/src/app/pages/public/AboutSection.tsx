...
export function AboutSection() {
  return (
    <section id="about" className="bg-background text-foreground border-t border-white/[0.04]">
      {/* Mission Hero */}
      <div className="pt-24 pb-20 px-6 relative overflow-hidden">
        <div
      ...
      <section className="pb-20 px-6">
        <div className="max-w-5xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map(({ label, value }, i) => (
            ...
            >
              <p className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-accent to-[#8B5CF6] mb-2">
                {value}
              </p>
              ...
              >
                ...
                <div>
                  <div className="flex items-baseline gap-3 mb-2">
                    <span className="text-foreground/20 font-bold text-xs">{num}</span>
